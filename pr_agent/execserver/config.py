...
# Expose Supabase configuration directly for imports
SUPABASE_URL = get_config("SUPABASE_URL") or os.getenv("SUPABASE_URL")
SUPABASE_ANON_KEY = get_config("SUPABASE_ANON_KEY") or os.getenv("SUPABASE_ANON_KEY")
